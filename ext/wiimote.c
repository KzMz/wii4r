...
static VALUE rb_wm_play_sound(VALUE self) {
  ...
  Data_Get_Struct(self, wiimote, wm);
  if(!wm) return Qnil;
  byte song[21] = {(unsigned char) (20 << 3), 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3, 0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3};
  wiiuse_play_sound(wm, song, 21);
  return Qnil;
}
